...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <section class="contenedor">
                <h2 class="bienvenida">FANTASIA</h2>
                <p class="pbienvenida">Cada persona cuando era niño imaginaba las cosas mas increibles del mundo y a la vez las mas imposibles, a medida que pasa el tiempo esta habilidad de imaginar cosas imposibles se pierde, con esta seccion buscamos que vuelva su niño interior, ese que creia que Papa Noel era real, dese la oportunidad de soñar sin importar que tan imposible parezca ese sueño.
                </p>
            </section>
            <section id="blog" class="parallax1-fan">
                <h3>Trabajemos la imaginacion.</h3>
                <section class="contenedor">
                    <article>
                        <img src="img/fan2.jpg" alt="Un pie gigante">
                        <h4>El gigante del cielo</h4>
                        <p class="autor">Jose Gomez 20 años</p>
                    </article>
                    <article>
                        <img src="img/fan3.jpg" alt="Una girafa gigante">
                        <h4>Mi amiga la girafa</h4>
                        <p class="autor">Daniel Sulaiman 21 años</p>
                    </article>
                </section>
            </section>
            <section id="info" class="parallax2-fan">
