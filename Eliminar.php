...
<html>
    ...
    <body class="Login">
        ...
        <section class="contenedor" id="Login-box">
            ...
            <h2 class="Login-h2">Confirme su identidad para eliminar su cuenta</h1>

            <form method="POST" action="EliminarCuenta.php">
                <label for="username">Numero de documento</label>
                <input  type="text" placeholder="Ingrese su numero de documento" name="Id_Pers_Confirm">

                <label for="password">Contraseña</label>
                <input type="password" placeholder="Ingrese su contraseña" name="Contraseña_Confirm">

                <p>Al dar en el boton de Eliminar cuenta dar por entendido que su cuenta sera borrada en su totalidad y que no se podra recuperar.</p>

                <input  type="submit" value="Eliminar la cuenta">
            </form>
        </section>
        <footer>
        </footer>
